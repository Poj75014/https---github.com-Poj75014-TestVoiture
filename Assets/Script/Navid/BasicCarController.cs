        ...
        void ApplyTorque()
        {
            ...
            for (int i = 0; i < m_axleInfos.Count; i++)
            {
                if (m_axleInfos[i].motor)
                {
                    ...
                    {
                        if (m_axleInfos[1].leftWheel != null)
                        {
                            m_axleInfos[1].leftWheel.brakeTorque = m_handBrake;
                        }
                        if (m_axleInfos[1].rightWheel != null)
                        {
                            m_axleInfos[1].rightWheel.brakeTorque = m_handBrake;
                        }
                    }
                }
            }
